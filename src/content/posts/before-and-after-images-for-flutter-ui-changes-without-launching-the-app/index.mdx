...
<Compare
  before={before}
  beforeAlt="A notification tile for “Your order has shipped”. The body text is cut off after one line with an ellipsis, and the “5m” timestamp sits to the right of the title."
  after={after}
  afterAlt="The same notification tile after the change. The body text wraps onto two lines instead of being cut off, and the “5m” timestamp now sits below the title."
/>
...
[https://pub.dev/packages/shutter](https://pub.dev/packages/shutter)

[https://github.com/koji-1009/shutter](https://github.com/koji-1009/shutter)
